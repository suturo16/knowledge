...
%% perceive_objects(+Name, +Pose, +Type, +Width, +Height, +Depth, -ObjInst) is det.
%
...
% @param Height The height of red of the object
% @param Depth The depth of green of the object
% @param ObjInst The object instance to be returned
perceive_objects(Name, Pose, Type, Width, Height, Depth, ObjInst) :- 
